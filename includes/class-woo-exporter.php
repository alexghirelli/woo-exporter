...
class Woo_Exporter {
	 ...
	 *
	 * - Woo_Exporter_Loader. Orchestrates the hooks of the plugin.
	 * - Woo_Exporter_i18n. Defines internationalization functionality.
	 * - Woo_Exporter_Admin. Defines all hooks for the admin area.
	 * - Woo_Exporter_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-woo-exporter-loader.php';
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-woo-exporter-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-woo-exporter-public.php';
	...
	private function set_locale() {
		...
		$plugin_i18n = new Woo_Exporter_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Woo_Exporter_Public( $this->get_plugin_name(), $this->get_version() );
